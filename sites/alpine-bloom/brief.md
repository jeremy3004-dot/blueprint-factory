...
A WHOA-inspired travel site and lightweight trekking operations demo for Alpine Bloom, a women-powered Himalayan travel agency.
...
- Feature donor: local Green Pastures trekking app at `/Users/dev/Projects/Travel Agency`.
...
- `/admin` demo operations board with lead creation, pipeline, trip holds, guide roster, and guide assignment.
- Preview APIs for booking, chat, and admin demo operations.
...
- Desktop and mobile screenshots show the WHOA structure translated to Himalayan content and the new feature pages.
- Public pages and preview APIs respond locally without external secrets.
