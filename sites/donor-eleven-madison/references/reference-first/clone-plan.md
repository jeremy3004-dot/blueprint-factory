# Clone Plan: donor-eleven-madison

Status: draft | complete -> draft (auto-captured; agent must verify)
Primary donor: elevenmadisonpark.com
Donor URL: https://www.elevenmadisonpark.com
...
Auto-drafted by `blueprint capture` on 2026-07-07T16:14:23.805Z. Mechanical fields are pre-filled; every
field below is a starting point the builder must verify against the screenshots and video.

- Sections captured: 3 (see `references/reference-first/sections/`)
- Assets inventoried: 42 (see `extraction/assets.json`, all reference-only until replaced)
- Fonts loaded: EB Garamond, Inter Tight, squarespace-ui-font, social-icon-font, nobel, plantin, neue-haas-grotesk-display
- Animation libraries: none detected via script/global signatures
- Dominant colors (by frequency): #000000 (579), #ffffff (33), #15325c (3), rgba(0, 0, 0, 0.5) (2), #15315a (1), #fc4837 (1)
- Heading font: (unknown) · Body font: EB Garamond
- Type scale (px, desc): 25, 21, 20, 18, 16, 12, 10

### Harvested page inventory (verify + set per-page status in section 1)

- `/` — Skip to Content [header]
- `/about` — Folder: About [header]
...
- `/faq` — FAQs [footer]
- `/giftcards` — Gift Cards [header]
- `/magic-farms` — Magic Farms [header]
- `/ourrestaurant` — About Us [header]
- `/press-and-accolades` — Press & Accolades [footer]
- `/shop` — Folder: Shop [header]
