# Clone Plan: avya-club-brand-source
...
Auto-drafted by `blueprint capture` on 2026-07-10T17:52:44.920Z. Mechanical fields are pre-filled; every
...
- Assets inventoried: 13 (see `extraction/assets.json`, all reference-only until replaced)
- Fonts loaded: Space Grotesk, Font Awesome 5 Brands, Font Awesome 5 Duotone, Font Awesome 5 Pro, flaticon
- Animation libraries: none detected via script/global signatures
- Dominant colors (by frequency): #777777 (336), #ffffff (101), #2d3436 (26), #aeaeae (25), #212121 (22), #f8f9fa (21), #3dbbad (14), #0d6efd (8), #2d3e50 (8), #5190a2 (8)
- Heading font: Space Grotesk · Body font: Space Grotesk
- Type scale (px, desc): 80, 70, 59, 36, 24, 22, 20, 18, 16, 14, 13, 12
